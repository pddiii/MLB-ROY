...
To not overkill this report with information I will skip over discussion of cleaning and pre-processing of the data. If you are interested please look no further than the [Data Cleaning Python Notebook](https://github.com/pddiii/MLB-ROY/blob/main/scripts_and_notebooks/roy_cleaning.ipynb) linked here. 
